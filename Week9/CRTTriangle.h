...
struct CRTTriangle {
    CRTVector v0, v1, v2;
    CRTVector edge0, edge1, edge2;   // precomputed edges
    CRTVector n;                     // face (flat) normal
    CRTVector n0, n1, n2;            // vertex normals (default = face normal)
    int materialIndex = 0;
    ...
    CRTTriangle(const CRTVector& a, const CRTVector& b, const CRTVector& c)
        ...
        n0 = n; n1 = n; n2 = n;      // until real vertex normals are set
    }
