...
// Triangle: vertices, face + vertex normals, per-vertex UVs, and a material index.
struct CRTTriangle {
    CRTVector v0, v1, v2;
    CRTVector edge0, edge1, edge2;
    CRTVector n;
    CRTVector n0, n1, n2;
    CRTVector uv0, uv1, uv2;         // texture coords per vertex (u,v in x,y)
    int materialIndex = 0;
    ...
    // Interpolated texture coordinate at the hit: uv1*u + uv2*v + uv0*(1-u-v).
